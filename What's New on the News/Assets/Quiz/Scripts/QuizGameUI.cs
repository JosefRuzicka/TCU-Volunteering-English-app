...
#pragma warning disable 649
    ...
    //public Button toggleMusicButtonPrefab;
...
#pragma warning restore 649
    ...
    */
    ...
    private void CreateButtons()
    {
        ...
        Button toggleMusicButton = Instantiate(toggleMusicButtonPrefab, buttonsParent);
        MusicToggle musicToggleScript = toggleMusicButton.GetComponent<MusicToggle>();
        if (musicToggleScript != null)
        {
            musicToggleScript.audioManager = audioManager; // Assign the AudioManager reference
        }
